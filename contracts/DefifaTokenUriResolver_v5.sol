...
contract DefifaTokenUriResolver is IDefifaTokenUriResolver, IJB721TokenUriResolver {
    ...
    function tokenUriOf(address _nft, uint256 _tokenId) external view override returns (string memory) {
        ...
        // Keep a reference to a simplified phase label for metadata traits.
        string memory _phaseTraitValue;
...

        {
            ...
            // Set the tier's name.
            _team = _delegate.tierNameOf(_tierId);
        ...
        string memory _attributes = string(
            abi.encodePacked(
                '[{"trait_type":"Match","value":"',
                _title,
                '"},{"trait_type":"Scoreline","value":"',
                _team,
                '"},{"trait_type":"Game ID","value":"',
                _gameId.toString(),
                '"},{"trait_type":"Tier ID","value":"',
                _tierId.toString(),
                '"},{"trait_type":"Phase","value":"',
                _phaseTraitValue,
                '"},{"trait_type":"Redeemable","value":"App & network tokens"},{"trait_type":"Total Picks","value":"',
        ...
        parts[3] = string(abi.encodePacked('","attributes":', _attributes, "}"));
